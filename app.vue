<template>
  ...
  <div class="flex ">
    ...
    <div class=" h-[calc(100vh-8rem)]  w-10 fixed right-0 md:right-16 justify-center flex items-center ">
      <ul>
        <li class="my-10 rounded-full border-2 border-black w-7  flex justify-center ">
          <NuxtLink :to="{ path: '/',hash:'#index'}" class=""><strong>.</strong></NuxtLink>
        </li>
        <li class="my-10 w-7  flex justify-center ">
          <NuxtLink :to="{ path: '/',hash:'#experience'}"><strong>.</strong></NuxtLink>
        </li>
        <li class="my-10 w-7  flex justify-center ">
          <NuxtLink :to="{ path: '/',hash:'#contact'}"><strong>.</strong></NuxtLink>
        </li>
        <li class="my-10 w-7  flex justify-center ">
          <NuxtLink :to="{ hash:'#contact'}"><strong>.</strong></NuxtLink>
        </li>
      </ul>
    </div>
</div>
